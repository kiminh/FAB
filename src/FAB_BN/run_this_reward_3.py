...
def run_env(budget_para):
    ...
    for episode in range(config['train_episodes']):
        ...
        if (episode > 0) and ((episode + 1) % 10 == 0):
            ...
            actions_df.to_csv(log_path + '/result_reward_3/train_actions_' + str(budget_para) + '.csv')
            ...
            hour_clks_df.to_csv(log_path + '/result_reward_3/train_hour_clks_' + str(budget_para) + '.csv')
            print(
